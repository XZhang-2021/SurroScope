...
(function (global) {
  ...
  var DICT = {
    zh: {
      ...
      "mark.bucket.star": "★ 最好",
      "mark.bucket.up": "👍 有价值",
      "mark.bucket.down": "👎 无价值",
      "mark.bucket.none": "未标注",
      "mark.star": "标记为这份数据下最好的模型",
      "mark.up": "标记为有价值",
      "mark.down": "标记为无价值",
      "mark.clear": "取消标记",
      "star.badge": "最好",
    ...
    en: {
      ...
      "mark.bucket.up": "👍 useful",
      "mark.bucket.down": "👎 not useful",
      "mark.bucket.none": "unmarked",
      "mark.star": "Mark as the best model for this dataset",
      "mark.up": "Mark as useful",
      "mark.down": "Mark as not useful",
      "mark.clear": "Clear the mark",
      "star.badge": "best",
